...
int TMVAClassification_neutron( TString myMethodList = "" )
{
   ...
   TString fname  = "/home/guang/work/theia/wc/outputTest_FHC.root";
   TString fname2 = "/home/guang/work/theia/wc/outputTest_FHC.root";
...
*/
   ...
   if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( dataloader, TMVA::Types::kBDT, "BDT",
                           "!H:!V:NTrees=850:MinNodeSize=2.5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=SDivSqrtSPlusB:nCuts=20" ); //(GiniIndex) SDivSqrtSPlusB:nCuts=20" );
