...
int TMVAClassification_gy( TString myMethodList = "" )
{
   ...
   //std::cout<<atoi(gApplication->Argv(5))<<" "<<atoi(gApplication->Argv(6))<<std::endl;
   ...
   TString fname = Form("/home/gyang/work/t2k/wc/combined_fluxWeightAdded_%dring%ddecay_hE.root", 0, 0 ); //atoi(gApplication->Argv(5)),atoi(gApplication->Argv(6)));
   TString fname2 = Form("/home/gyang/work/t2k/wc/combined_fluxWeightAdded_%dring%ddecay_bkg_hE.root", 0, 0 ); //atoi(gApplication->Argv(5)),atoi(gApplication->Argv(6)));
...
if( 1){ //atoi(gApplication->Argv(5))==1){
...
else if(1){ //atoi(gApplication->Argv(5))==2){
   dataloader->AddVariable( "var1:=fqpi0mom1[0]", "fqpi0mom1[0]", "units",  'F' );
   dataloader->AddVariable( "var2:=fqpi0mom2[0]", "fqpi0mom2[0]", "units", 'F' );
