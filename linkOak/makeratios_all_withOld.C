...
// ************ all ************
  ...
  for (int inu=0; inu < nccqenutypes; inu++) {
	...
	std::cout<<"%precuts_NUE_QE_orig = {"<<std::endl;
	for (int ibin=0; ibin<nbins; ibin++) {
	...
	std::cout<<"}"<<std::endl;
	std::cout<<"%precuts_NUE_QE = interpolation(%energy_pre,%precuts_NUE_QE_orig,1,%sbc)"<<std::endl;
	std::cout<<std::endl;
  ...
  for (int inu=0; inu < nccqenutypes; inu++) {
	...
	std::cout<<"%likelihood_NUE_QE_orig = {"<<std::endl;
        for (int ibin=0; ibin<nbinsPost; ibin++) {
          yvalsPost[ibin] = repiccqePost[inu]->GetBinContent(ibin+1);
	  std::cout<<yvalsPost[ibin]<<", ";
          xvalsPost[ibin] = ibin;
        }
	std::cout<<"}"<<std::endl;
	std::cout<<"%likelihood_NUE_QE = interpolation(%energy_post,%likelihood_NUE_QE_orig,1,%bc)"<<std::endl;
	std::cout<<std::endl;
  ...
  for (int inu=0; inu < nccpipnutypes; inu++) {
	...
	std::cout<<"%precuts_NUE_NQE_orig ={"<<std::endl;
	for (int ibin=0; ibin<nbins; ibin++) {
	...
	std::cout<<"}"<<std::endl;
	std::cout<<"%precuts_NUE_NQE = interpolation(%energy_pre,%precuts_NUE_NQE_orig,1,%sbc)"<<std::endl;
	std::cout<<std::endl;
  ...
  for (int inu=0; inu < nccpipnutypes; inu++) {
        ...
        std:cout<<"%likelihood_NUE_NQE_orig = {"<<std::endl;
        for (int ibin=0; ibin<nbinsPost; ibin++) {
	...
	std::cout<<"}"<<std::endl;
	std::cout<<"%likelihood_NUE_NQE = interpolation(%energy_post,%likelihood_NUE_NQE_orig,1,%bc)"<<std::endl;
	std::cout<<std::endl;
