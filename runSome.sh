...
do
  ...
  do
	...
	#./runsklooper 0.25 FHC 2 1 $VAR $ESTEP $TSTEP
        ...
        ./runsklooper 0.02 FHC 3 2 $VAR $ESTEP $TSTEP
        ./runsklooper 0.02 FHC 5 2 $VAR $ESTEP $TSTEP
        ./runsklooper 0.02 FHC 5 4 $VAR $ESTEP $TSTEP

	./runsklooper 0.0 FHC 3 2 $VAR $ESTEP $TSTEP
        ./runsklooper 0.0 FHC 5 2 $VAR $ESTEP $TSTEP
        ./runsklooper 0.0 FHC 5 4 $VAR $ESTEP $TSTEP
     done
  done
done
